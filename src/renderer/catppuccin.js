/* Catppuccin palettes, generated from catppuccin/palette palette.json.
   Restricted to the names komorebi's CatppuccinValue enum accepts, so a swatch
   can never offer a colour the config would reject. */

const CATPPUCCIN_FLAVOURS = {
  Mocha: {
  ...
  Frappe: {
    ...
    Red: "#e78284", Maroon: "#ea999c", Peach: "#ef9f76", Yellow: "#e5c890", Green: "#a6d189",
